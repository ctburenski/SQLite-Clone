...
typedef struct {
  StatementType type;
  Row row_to_insert; // only for isnert statement
} Statement;


// These constants keep the program from compiling
// using the gcc compiler instead of clang
...
int main(int argc, char *argv[]) {
  // program will not flush reliably without this statement
